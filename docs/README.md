...
| `trial-013-low-actionability-report.md` | Meaning-trial record | Pre-registers H-A/H-B, directional predictions, falsifiers, selection rule, sealed holdout, and verdict evidence for Low actionability |
