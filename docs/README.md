...
| `lead-iteration-map-2026-08-14.md` | Lead proposal | E01 review verdict, ordered iteration map with falsifiable shapes, the Give verb pick, scaffolding notes S1–S7, and the standing author-decision list — for author + drift-master review |
