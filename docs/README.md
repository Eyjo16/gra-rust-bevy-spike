...
| `trial-012-confluence-shape-report.md` | Standalone evidence | Falsifies non-separable interaction in the active yield cell and defines the semantic/holdout gate before value movement |
