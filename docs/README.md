...
| `trial-011-threshold-edge-chains-report.md` | Standalone measurement evidence | Records current-base gather/witness chains at stamina edges while leaving the 39→40 meaning question open |
